...
export { diagnoseDeck, type DeckDiagnosis, type SlideIssue, type DoctorSeverity } from './pipeline/doctor.js'
export { autoFixDeck, type AutoFixResult } from './pipeline/doctor-fix.js'
